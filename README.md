...
<details>
  <ul>
    <li><a href="https://www.https://ruby-doc.org/">Ruby on Rails</a></li>
  </ul>
</details>
...
- **User Interaction**
- **Active Record ORM Framework for Rails**
...
- install ruby
- install rails and set up a project with postgresql DB.
...
```sh
  cd my-folder
  git clone  https://github.com/Ellon-M/ror-blog-app.git
```

### Usage

To view the project, run `rails s`.
